...
import static net.congstar.jira.plugins.scrumpoker.data.DefaultScrumPokerSettings.SETTINGS_NAMESPACE;
import static net.congstar.jira.plugins.scrumpoker.data.DefaultScrumPokerSettings.STORY_POINT_FIELD;
